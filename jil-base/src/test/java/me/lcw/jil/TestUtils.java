...
public class TestUtils {
  ...
  public static JilImage GreyImageGenerator() {
    if(greyImage == null) {
      ...
      for(int i=0; i<1080; i++) {
        ...
        img.getImageDrawer().drawLine(0, i, 480, i, new Color(tmp), 0, false);
      }
    }
  ...
  public static JilImage RGBAImageGenerator() {
    if(rgbaImage == null) {
      ...
      img.getImageDrawer().drawRect(0, 0, 480, 20, c, 1, true);
      c = Color.RED.changeAlpha((byte) 100);
      img.getImageDrawer().drawRect(0, 20, 480, 20, c, 1, true);
      c = Color.RED.changeAlpha((byte) 200);
      img.getImageDrawer().drawRect(0, 20*2, 480, 20, c, 1, true);
      img.getImageDrawer().drawRect(0, 20*3, 480, 20, Color.RED, 1, true);
      
      c = Color.GREEN.changeAlpha((byte) 50);
      img.getImageDrawer().drawRect(0, 20*4, 480, 20, c, 1, true);
      c = Color.GREEN.changeAlpha((byte) 100);
      img.getImageDrawer().drawRect(0, 20*5, 480, 20, c, 1, true);
      c = Color.GREEN.changeAlpha((byte) 200);
      img.getImageDrawer().drawRect(0, 20*6, 480, 20, c, 1, true);
      img.getImageDrawer().drawRect(0, 20*7, 480, 20, Color.GREEN, 1, true);
      
      c = Color.BLUE.changeAlpha((byte) 50);
      img.getImageDrawer().drawRect(0, 20*8, 480, 20, c, 1, true);
      c = Color.BLUE.changeAlpha((byte) 100);
      img.getImageDrawer().drawRect(0, 20*9, 480, 20, c, 1, true);
      c = Color.BLUE.changeAlpha((byte) 200);
      img.getImageDrawer().drawRect(0, 20*10, 480, 20, c, 1, true);
      img.getImageDrawer().drawRect(0, 20*11, 480, 20, Color.BLUE, 1, true);
      rgbaImage = img;
    }
  ...
  public static JilImage RGBImageGenerator() {
    if(rgbImage == null) {
      ...
      for(int i=0; i<img.getHeight(); i++) {
        ...
        img.getImageDrawer().drawLine(0, i, img.getWidth(), i, c, 0, false);
      }
      rgbImage = img;
    }
