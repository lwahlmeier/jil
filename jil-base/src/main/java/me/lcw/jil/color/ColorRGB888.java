...
public class ColorRGB888 implements Color {
   ...
   */
  public ColorRGB888(byte red, byte green, byte blue) {
    this.red = red;
    this.green = green;
    this.blue = blue;
  }
  ...
  public ColorRGB888 changeBlue(byte lblue) {
    return new ColorRGB888(red, green, lblue);
  }
  ...
  @Override
  public ColorRGB888 changeRed(byte lred) {
    return new ColorRGB888(lred, green, blue);
  }
  ...
  @Override
  public ColorRGB888 changeGreen(byte lgreen) {
    return new ColorRGB888(red, lgreen, blue);
  }
