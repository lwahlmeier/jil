...
/**
 * This encoder is a very basic fully java implementation of TIFF image reader and writer. 
 * 
 * NOTE: Currently this is just a very very basic implementation!
 */
public class TiffFile {
  ...
  public static void save(String saveTo, BaseImage image) throws IOException, ImageException {
    final byte[] data = image.changeMode(BaseImage.MODE.RGB).getArray();
